...
class Joystick(Node):
    def __init__(self):
        ...
        self.pub_shoot = self.create_publisher(
            Twist, "/teelek/cmd_shoot", qos_profile=qos.qos_profile_system_default
        )

        self.pub_servo = self.create_publisher(
            Twist, "/teelek/cmd_servo", qos_profile=qos.qos_profile_system_default
        )

        self.pub_encoder = self.create_publisher(
            Twist, "/teelek/cmd_encoder", qos_profile=qos.qos_profile_system_default
        )
